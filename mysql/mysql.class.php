...
class MySQL
{
	...
	private $db_host    = "mysql.holooli.com";  // server name
	private $db_user    = "saeed_user";       // user name
	private $db_pass    = "Z%@DSz2a34";           // password
	private $db_dbname  = "saeed_db";           // database name
